...
df_parquet <- spark_read_parquet(
  sc,
  name = "df_parquet",  # name of the Spark DataFrame (internal)
  path = "/Users/carmen/Desktop/DEBIAS/geocoded-hex10-parquet-test-fr",  # folder or single .parquet file
  memory = TRUE  # load into Spark memory (set FALSE if too big)
)
