...
if (month == TRUE) {
  input_path <- file.path(wd, "mapp1", "home", "device-locations-home_time-aggregation_month")
} else {
  input_path <- file.path(wd, "mapp1", "home", "device-locations-home_time-aggregation")
}
...
if (month == TRUE) {
  output_path <- file.path(wd, "mapp1", "home", "location-home_month")
  if (dir_exists(output_path)) dir_delete(output_path) 
} else {
  output_path <- file.path(wd, "mapp1", "home", "location-home")
  if (dir_exists(output_path)) dir_delete(output_path) 
}
