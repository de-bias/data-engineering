...
input_path <- file.path(wd, "location-home_parquet-test")
...
# Aggregate into geographies and save as
...
st_write(sdf_lda, "/Volumes/DEBIAS/data/outputs/mapp1/locations-home/lad/home-location-count_lda_test.gpkg")
```
