...
```{r}
write_csv(pop_count, paste0(wd, "/data/inputs/mapp2/locations-origin/lad/location-origin-count_lad.csv"))
```
...
```{r}
write_csv(pop_count, paste0(wd, "/data/inputs/mapp2/locations-origin/lad/location-home-count_lad_htw.csv"))
```
