...
```{r}
write_csv(pop_count, "/Volumes/rdm04/DEBIAS/data/outputs/mapp2/home-locations/lad/home-location-count_lad.csv")
```
...
```{r}
write_csv(pop_count, "/Volumes/rdm04/DEBIAS/data/outputs/mapp2/home-locations/lad/home-location-count_lad_htw.csv")
```
