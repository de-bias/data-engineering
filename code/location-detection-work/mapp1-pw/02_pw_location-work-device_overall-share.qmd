...
input_path <- file.path(wd, "work", "device-locations_09t16")

if (month == TRUE) {
  input_path <- file.path(wd, "mapp1", "work", "device-locations_09t16-month")
} else {
  input_path <- file.path(wd, "mapp1", "work", "device-locations_09t16")
}
...
if (month == TRUE) {
  output_path <- file.path(wd, "mapp1", "work", "device-locations-work_time-aggregation_month")
  if (dir_exists(output_path)) dir_delete(output_path)  
} else {
  output_path <- file.path(wd, "mapp1", "work", "device-locations-work_time-aggregation")
  if (dir_exists(output_path)) dir_delete(output_path)
}
...
# 
# parent_path <- file.path(wd, "device-locations_09t16_parallelised")
# 
