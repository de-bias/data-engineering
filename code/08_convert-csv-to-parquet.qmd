...
if(!dir.exists("/Volumes/rdm04/DEBIAS/data/inputs/pickwell/uk_parquet/converted_parquet_2")) {
  dir.create("/Volumes/rdm04/DEBIAS/data/inputs/pickwell/uk_parquet/converted_parquet_2")
  }
...
write_dataset(csv_ds, 
                "/Volumes/rdm04/DEBIAS/data/inputs/pickwell/uk_parquet/converted_parquet_2", 
                format = "parquet")
# 
#                 , partitioning = c("day"))
