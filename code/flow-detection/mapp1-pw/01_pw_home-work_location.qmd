...
if (month == TRUE) {
  input_path_home <- file.path(wd, "mapp1", "home", "location-home-month")
} else {
...
if (month == TRUE) {
  input_path_work <- file.path(wd, "mapp1", "work", "location-work-month")
} else {
...
if (month == TRUE) {
  write.csv(df_flows, "/Volumes/DEBIAS/data/inputs/mapp1/flows/lad/flow-home-work_msoa_htw_pw-month.csv")
} else {
  write.csv(df_flows, "/Volumes/DEBIAS/data/inputs/mapp1/flows/lad/flow-home-work_msoa_htw_pw.csv")
}
```
