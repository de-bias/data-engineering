...
if (month == TRUE) {
  write.csv(mov_lad_tts, "/Volumes/DEBIAS/data/inputs/fb/census-month/tts/htw-lad-tts.csv")
} else {
  write.csv(mov_lad_tts, "/Volumes/DEBIAS/data/inputs/fb/census-week/tts/htw-lad-tts.csv")
}
...
if (month == TRUE) {
  write.csv(mov_lad_stt, "/Volumes/DEBIAS/data/inputs/fb/census-month/stt/htw-lad-stt.csv")
} else {
  write.csv(mov_lad_stt, "/Volumes/DEBIAS/data/inputs/fb/census-week/stt/htw-lad-stt.csv")
}
```
