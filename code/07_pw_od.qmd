...
df_boundaries <- st_read(paste0(wd, "/data/inputs/geographies/boundaries/OA_2021_EW_BFC_V8.gpkg")) %>% select(OA21CD, SHAPE) %>% rename("code" = "OA21CD")

df_boundaries <- st_transform(df_boundaries, st_crs(4326))
...
write_parquet(paste0(wd, "/data/outputs/pw/home-locations/hex/home-location_hex.parquet"))
saveRDS((paste0(wd, "/data/outputs/pw/home-locations/hex/home-location_hex.rds"))
```
