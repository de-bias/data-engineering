...
data_parent_folder <- file.path(working_directory, "home_location_new_1", "before_war_new_2")
...
save_location <- file.path(working_directory, "home_location_new_2", "before_war_new_2")
